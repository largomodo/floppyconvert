...
*floppyconvert* [*-hvV*] [*--format*=_<format>_] [*-o*=_<outputDir>_]
              [*--ucon64-path*=_<ucon64Path>_] _INPUT_
...
Automates the conversion of SNES ROM files (.sfc, .fig, .smw, .swc, .ufo) into FAT12 floppy disk images compatible with retro backup units.
