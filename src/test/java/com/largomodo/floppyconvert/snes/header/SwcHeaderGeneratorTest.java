...
class SwcHeaderGeneratorTest {
    ...
    void headerSizeIsAlways512Bytes(@ForAll("anyRom") SnesRom rom,
        ...
        byte[] header = generator.generateHeader(rom, partIndex, isLastPart);
    ...
    void sizeCalculationFor4MbitRom() {
        ...
        int expectedBlocks = romSize / 8192;
        int actualBlocks = (header[0] & 0xFF) | ((header[1] & 0xFF) << 8);

        assertEquals(expectedBlocks, actualBlocks,
                "Size field should contain ROM size in 8KB blocks");
        assertEquals(512, actualBlocks, "4 Mbit ROM should be 512 blocks");
    }
    ...
    void sizeCalculationFor8MbitRom() {
        ...
        assertEquals(expectedBlocks, actualBlocks,
                "Size field should contain ROM size in 8KB blocks");
        assertEquals(1024, actualBlocks, "8 Mbit ROM should be 1024 blocks");
    }
